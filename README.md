...
***Note 1: For the assignments completed during my 2-month internship at Celebal Technologies, please refer to the main branch of the same repository.***
***(Note 2: For the outputs, please refer to the `Screenshots` folder and for the project report, please refer to the `Documentation` folder.)***
